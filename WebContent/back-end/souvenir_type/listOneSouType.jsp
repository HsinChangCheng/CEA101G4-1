...
<%
	SouvenirTypeVO soutVO = (SouvenirTypeVO) request.getAttribute("soutVO"); //EmpServlet.java(Concroller), 存入req的empVO物件
%>
...
<title>特產種類資料 - listOneSoutype.jsp</title>
...
<body bgcolor='white'>
	<div class="container-fluid">
		...
		<table id="table-1">
			<tr>
				<td>
					<h3>特產種類資料 - ListOneSouType.jsp</h3>
					<h4>
						<a href="/CEA101G4/back-end/souvenir/select_soutype_page.jsp">回首頁</a>
					</h4>
				</td>
			</tr>
		</table>
