...
<%
ActivityTypeVO acttypeVO = (ActivityTypeVO) request.getAttribute("acttypeVO");
%>
...
<title>活動種類資料新增 - addActivityType.jsp</title>
...
<body bgcolor='white'>
	...
	<table id="table-1">
		<tr>
			<td>
				<h3>員工資料新增 - addActivityTypeMem.jsp</h3>
			</td>
			<td>
				<h4>
...
<%-- 					value="<%= (acttypeVO==null)? "TEST213123" : acttypeVO.getAct_type_id()%>" /></td> --%>
<!-- 			</tr> -->
			<tr>
				<td>活動種類名稱:</td>
				<td><input type="TEXT" name="act_type_name" size="45"
					value="<%= (acttypeVO==null)? "1321" : acttypeVO.getAct_type_name()%>" /></td>
			</tr>
