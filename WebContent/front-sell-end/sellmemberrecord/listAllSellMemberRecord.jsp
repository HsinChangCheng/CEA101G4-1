...
<%
	...
	List<SellMemRecordVO> list = sellMemRecordSvc.getAll();
...
<html>
<head>
<title>所有評論資料 - listAllSellMemberRecord.jsp</title>
</head>
<style>
table#table-1 {
...
<body bgcolor='white'>
	...
	<table id="table-1">
		<tr>
			<td>
				<h3>所有員工資料 - listAllSellMemberRecord.jsp</h3>
				<h4>
	...
	<table>
		...
		<c:forEach var="sellMemRecordVO" items="${list}" begin="<%=pageIndex%>"
				...
				<td>
					<FORM METHOD="post"
						...
						<input type="submit" value="修改"> <input type="hidden"
							name="sellMemRecordId" value="${sellMemRecordVO.sellMemRecordId}"> <input
