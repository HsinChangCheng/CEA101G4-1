...
%>
<%-- <%= sellMemRecordVO==null %>--${sellMemRecordVO.deptno}-- --%>
		...
		<table>
			<tr>
				...
				<td><input type="TEXT" name="sellMemId" size="45"
					value="<%=(sellMemRecordVO == null) ? "SELL00" : sellMemRecordVO.getSellMemId()%>" /></td>
			</tr>
			<tr>
				<td>會員通知內容:</td>
			...
			<tr>
				<td>活動評論狀態:</td>
				<td><input type="radio" name="sellMemRecordRead" size="45" value="0" />未讀
					<input type="radio" name="sellMemRecordRead" size="45" value="1" />已讀
					</td>
			</tr>
