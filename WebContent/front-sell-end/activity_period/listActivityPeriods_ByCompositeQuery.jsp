...
<jsp:useBean id="listActivityPeriod_ByCompositeQuery" scope="request" type="java.util.List<ActivityPeriodVO>" />
...
<table>
	...
	<c:forEach var="empVO" items="${listActivityPeriods_ByCompositeQuery}">
