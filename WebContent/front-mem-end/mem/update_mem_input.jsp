		...
		<table>
			...
			<tr>
				...
				<td><input type="TEXT" name="mem_account" size="45"
					value="<%=memVO.getMem_account()%>" /></td>
			</tr>
			<tr>
				<td>會員密碼:</td>
				<td><input name="mem_pwd" type="TEXT"
					value="<%=memVO.getMem_pwd()%>" /></td>
			</tr>
			<tr>
				<td>會員生日:</td>
				<td><input type="TEXT" name="mem_birth" size="45" id="f_date1"
					value="<%=memVO.getMem_birth()%>" /></td>
			</tr>
			<tr>
				<td>會員電話:</td>
			...
			<tr>
				...
				<td><input type="TEXT" name="mem_mail" size="45"
					value="<%=memVO.getMem_mail()%>" /></td>
			</tr>

			<tr>
				<td>會員身份證字號:</td>
				<td><input type="TEXT" name="mem_id_number" size="45"
					value="<%=memVO.getMem_id_number()%>" /></td>
			</tr>
			...
			<tr>
				...
				<td><input type="TEXT" name="mem_gender" size="45"
					value="<%=memVO.getMem_gender()%>" /></td>
			</tr>

			<tr>
				<td>會員加入時間:</td>
				<td><input type="TEXT" name="mem_jointime" size="45" id="f_date2"
					value="<%=memVO.getMem_jointime()%>" /></td>
			</tr>
